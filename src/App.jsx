    ...
    <div className='bg-slate-950 text-slate-100 selection:bg-fuchsia-500/30'>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="fixed right-0 top-0 h-full w-80 bg-slate-900 border-l border-white/10 p-6">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className='p-2 rounder-lg' onClick={() => setOpen(false)}>
                      <X className='size-5' />
                    </button>
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-6xl px-4 py-20 relative">
          ...
          >
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa magni rerum, exercitationem vitae accusantium illum ipsum veniam quidem earum ipsa quos aliquid?
          </motion.p>
          ...
          >
            ...
            <a href="#" className='inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 font-medium transition border border-white/10 hover:bg-white/5 transition'>Ver recursos</a>
          </motion.div>
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-8">
        ...
        <p className='text-slate-300 mt-2 max-w-2xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis at blanditiis laudantium sint officiis doloremque eaque.</p>
          ...
          {[1, 2, 3].map(i => (
            ...
            <blockquote key={i} className='rounded-2xl border border-white/10 p-6'>
              ...
              <p className='mt-3 text-slate-300'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae nesciunt quam et magnam sequi molestias, amet commodi sapiente voluptates, quo, officia doloribus!
              </p>
      ...
      <section id='pricing' className="mx-auto max-w-6xl px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div>
            ...
            <p className='text-slate-300 mt-6 max-w-2xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis at blanditiis laudantium sint officiis doloremque eaque.</p>
